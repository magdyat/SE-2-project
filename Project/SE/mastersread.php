...
echo "<table >";
        ...
        try {
            ...
            $stmt = $conn->prepare("SELECT id, firstname, lastname , email , phone , age ,graduation , birth , address , governorate , nationality , N_ID , job , bachelore , gpa , university ,faculty , h_studies , university1 , faculty1 ,department FROM master");
            $stmt->execute();
            ...
            foreach ($stmt->fetchAll() as $row) {
                ...
                echo "<td><a href='mastersread1.php?id=".$row['id']."'>Reject And Delete></a></td>";
                echo "</tr>";
            }
